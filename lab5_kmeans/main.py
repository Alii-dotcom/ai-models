...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', choices=('gaussians', 'twomoon', 'avengers'),
                        default='avengers', help='dataset to use')
    p = parser.parse_args()
    ...
    if p.dataset == 'avengers':
        main_kmeans_img('C:\\Users\\alice\\OneDrive\\Desktop\\IA\\lab5_kmeans\\img\\tony.jpg', 'C:\\Users\\alice\\OneDrive\\Desktop\\IA\\lab5_kmeans\\img\\aereo.jpg') 
